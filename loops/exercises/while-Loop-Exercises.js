...
let fuelLevel = 0;    let altitude = 0;
...
let numOfAstronauts = input.question("Enter the number of Astronauts aboard: ")
while (numOfAstronauts > 7){
    numOfAstronauts = input.question("Over maximum number allowed, please enter new number: ");
}
